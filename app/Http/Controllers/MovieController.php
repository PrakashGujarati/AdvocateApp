...
class MovieController extends Controller
{
    ...
    {
        return view('MovieShow.Movie.view');
    }
    ...
    public function getDataTable()
    {
        ...
        return DataTables::of($movies)
            ->addColumn('edit',function ($movie){
                return '<button type="button" class="edit btn btn-sm btn-primary" data-title="'.$movie->title.'" data-description="'.$movie->description.'" data-duration-min="'.$movie->duration_min.'" data-id="'.$movie->id.'">Edit</button>';
            })
